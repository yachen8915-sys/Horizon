...
def main():
    ...
    try:
        ...
        if not presets_path.exists():
            presets_path_text = "data/presets.json"
        elif Path(args.data_dir) == Path("data"):
            presets_path_text = "data/presets.json"
        else:
            presets_path_text = str(presets_path)
        presets = load_presets(presets_path=presets_path_text, prefer_api=True)
